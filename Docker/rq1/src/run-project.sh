...
for algo in $algos; do
    ...
    if [ -d /opt/pymop-artifacts-rv/pymop/specs-new ]; then
        ls -al /opt/pymop-artifacts-rv/pymop/specs-new
    fi
    echo "================================================"
    ...
    if [ "$algo" = "ORIGINAL" ]; then
        ...
        timeout $timeout pytest \
            ...
            -p pythonmop \
            -rA \
            --path=/opt/pymop-artifacts-rv/pymop/specs-new/\
            --algo $algo \
            --continue-on-collection-errors \
            --statistics \
            --instrument_strategy=builtin \
